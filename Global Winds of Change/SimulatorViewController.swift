...
//
//  Created by Lamont Johnson on 5/11/23.
//
        ...
        func currentType() {
            ...
            func influenceSeaTemperatures() {
                ...
                case: currentStrength = 1
                    newWaterTemperature = (currentTemperature+waterTemperature)/2.06
                 print(newWaterTemperature)
                case: currentStrength = 2
                    newWaterTemperature = (currentTemperature+waterTemperature)/2.02
                case: currentStrength = 4
                    newWaterTemperature = (currentTemperature+waterTemperature)/1.98
                case: currentStrength = 5
                    newWaterTemperature = (currentTemperature + waterTemperature)/1.94
